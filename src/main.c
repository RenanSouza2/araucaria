...
static void time_assembly_sqr()
{
    ...
    TIME_END(t3)
    tprintf("time sqr ssm     : %.3f", dtime(t3));
    num_free(num_res);
...
// time_assembly_sqr       | time sqr classic : 69.494 | original
// time_assembly_sqr       | time sqr ssm     : 69.231

// time_assembly_sqr       | time mul classic : 0.578
// time_assembly_sqr       | time sqr classic : 1.042
// time_assembly_sqr       | time sqr ssm     : 0.017
// time_assembly_sqr       | time sqr ssm     : 0.024